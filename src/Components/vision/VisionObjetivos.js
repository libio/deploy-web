...
const VisionObjetivos = ({ children }) => {
  return (
    <Fragment>
      {children}
      <section id="about">
        <div className="container mt-5" data-aos="fade-up">
          <header className="section-header text-center">
            ...
            <p>
              ...
              nuestro distrito de <strong>CHECACUPE</strong> y de la provincia
              de Canchis. Para ello nuestra comunidad ha proirizado diferentes
          ...
          <div className="col-md-12" data-aos="fade-up">
            <ul>
              ...
              <li>
                ...
                nuestra propiedad comunal y los recursos que en él se
                encuentren.
              </li>
              ...
              <li>
                Elevar la autoestima y calidad de vida de nuestros comuneros y
                la sociedad de <strong>Cangalli</strong>.
              </li>
              <li>
          ...
          <div className="col-md-12" data-aos="fade-up">
            <ul>
              ...
              <li>
                Vamos adquiriendo más maquinarias para mejorar nuestros ingresos
                y seguir impulsando la mejora de la calidad de vida.
              </li>
              <li>
                Con los tractores agrícolas y nuestro molino de granos, deseamos
                cambiar el manejo de ganado en la zona, y apoyado con el
                concurso de dos veterinarios mejorar la calidad, producción y
                productividad agropecuaria que nos permita iniciar la
                transformación de productos y a futuro llegar con un valor
                agregado de nuestros productos y logremos ser competitivos en el
                mercado.
              </li>
            </ul>
          </div>
